        ...
        <header className="sticky top-0 z-40 bg-cream/95 backdrop-blur-sm border-b border-rule">
          <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-1 text-sm text-ink-muted">
              ...
              <Link href="/browse" className="px-3 py-2 hover:text-sienna transition-colors rounded text-ink-faint text-xs">
                Browse
              </Link>
              ...
              <span className="text-rule">|</span>
              <Link href="/contribute" className="px-3 py-2 hover:text-sienna transition-colors rounded text-ink-faint text-xs">
                Contribute
              </Link>
            </nav>
            {/* Mobile hamburger */}
