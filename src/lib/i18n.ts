...
const translations = {
  ...
  search_placeholder:{ vi: 'Tìm kiếm trích dẫn... / Search quotes...', en: 'Search quotes... / Tìm kiếm...' },
  ...
  no_quotes_sub:     { vi: 'No quotes found matching your filters.', en: 'Không tìm thấy trích dẫn nào phù hợp.' },
  clear_filters:     { vi: 'Xoá bộ lọc / Clear filters',    en: 'Clear filters / Xoá bộ lọc' },
